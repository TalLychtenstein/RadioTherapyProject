...
def extract_group1_metadata(RP_data, RD_data, patient_folder_path) -> Dict[str, Any]:
    ...
    *The function is resilient to missing DICOM tags and non‑standard planners –
    ...
    meta: Dict[str, Any] = {
        ...
        "Prescription Dose or Max Dose[Gy]":   None,
    ...
    if meta["Prescription Dose or Max Dose[Gy]"] and meta["Number of Fractions"]:
        meta["Dose per Fraction [Gy]"] = (
            meta["Prescription Dose or Max Dose[Gy]"] / meta["Number of Fractions"]
        )
